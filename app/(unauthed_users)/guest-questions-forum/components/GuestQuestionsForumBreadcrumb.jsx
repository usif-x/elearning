...
const GuestQuestionsForumBreadcrumb = ({ questionSetId, questionSetTitle }) => {
  return (
    <div
    ...
    >
      ...
      <Link
        href={`/guest-questions-forum/${questionSetId}`}
        className="hover:text-sky-500 transition-colors"
      >
        {questionSetTitle}
      </Link>
...
export default GuestQuestionsForumBreadcrumb;
