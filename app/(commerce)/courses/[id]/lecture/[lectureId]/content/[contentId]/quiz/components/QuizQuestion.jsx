...
const QuizQuestion = ({
  ...
  // Helper to detect Arabic text for dynamic direction
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 w-full max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 pb-4 border-b border-slate-200 dark:border-slate-700 gap-4">
        <h2
        ...
        <div className="flex items-center flex-wrap gap-2">
          {/* Answered Badge */}
          {answer !== null && (
            <span className="bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 text-xs font-bold px-3 py-1.5 rounded-full">
              تم الإجابة ✓
            </span>
          )}
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-all border text-sm font-semibold
              ${
                flaggedQuestions.has(currentQuestionIndex)
                  ? "bg-amber-50 border-amber-200 text-amber-600 dark:bg-amber-900/20 dark:border-amber-800 dark:text-amber-400"
                  : "bg-slate-100 border-transparent text-slate-500 hover:bg-amber-50 hover:text-amber-600 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-amber-900/10"
              }`}
            title="Mute/Flag"
          >
            <Icon
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-600 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300 transition-colors text-sm font-semibold"
      ...
      <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-4 pt-6 border-t border-slate-200 dark:border-slate-700">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          {/* Clear Button (Only shows if answered) */}
          {answer !== null && (
            <button
