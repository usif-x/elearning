...
import { getAttemptDetail } from "@/services/QuestionsForum";
...
const AttemptDetailPage = () => {
  ...
  const isPassed = attempt.score >= 50; // Assuming 50% is passing score
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          {attempt.questions_with_results &&
            filterQuestions(attempt.questions_with_results).map(
              (item, index) => (
                <div
                      ...
                      <div className="flex items-start gap-2 sm:gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            {item.question.explanation_ar &&
                              item.question.explanation_en && (
                                ...
                                >
                                  ...
                                  />
                                  <span>
                                    {explanationLang[item.originalIndex] ===
                                    "en"
                                      ? "عربي"
                                      : "English"}
                                  </span>
                          ...
                          <p
                            ...
                            dir={
                              explanationLang[item.originalIndex] === "en"
                                ? "ltr"
                                : "rtl"
                            }
                          >
        ...
        <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
          ...
          >
            <Icon
              ...
              className="w-4 h-4 sm:w-5 sm:h-5"
            />
            <span>العودة لمنتدى الأسئلة</span>
          </Link>
        </div>
      </div>
    </div>
